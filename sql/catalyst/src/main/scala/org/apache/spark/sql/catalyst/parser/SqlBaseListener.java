...
public interface SqlBaseListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code noWithQuery}
	 * labeled alternative in {@link SqlBaseParser#queryNoWith}.
	 * @param ctx the parse tree
	 */
	void enterNoWithQuery(SqlBaseParser.NoWithQueryContext ctx);
	/**
	 * Exit a parse tree produced by the {@code noWithQuery}
	 * labeled alternative in {@link SqlBaseParser#queryNoWith}.
	 * @param ctx the parse tree
	 */
	void exitNoWithQuery(SqlBaseParser.NoWithQueryContext ctx);
	/**
	 * Enter a parse tree produced by the {@code queryWithFrom}
	 * labeled alternative in {@link SqlBaseParser#queryNoWith}.
	 * @param ctx the parse tree
	 */
	void enterQueryWithFrom(SqlBaseParser.QueryWithFromContext ctx);
	/**
	 * Exit a parse tree produced by the {@code queryWithFrom}
	 * labeled alternative in {@link SqlBaseParser#queryNoWith}.
	 * @param ctx the parse tree
	 */
	void exitQueryWithFrom(SqlBaseParser.QueryWithFromContext ctx);
	/**
