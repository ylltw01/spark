...
public interface SqlBaseVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code noWithQuery}
	 * labeled alternative in {@link SqlBaseParser#queryNoWith}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNoWithQuery(SqlBaseParser.NoWithQueryContext ctx);
	/**
	 * Visit a parse tree produced by the {@code queryWithFrom}
	 * labeled alternative in {@link SqlBaseParser#queryNoWith}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitQueryWithFrom(SqlBaseParser.QueryWithFromContext ctx);
	/**
